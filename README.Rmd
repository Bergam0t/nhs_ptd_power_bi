...
**!! At the moment this only works in the PowerBI desktop application - while this may be useful for automating the reporting of some KPIs as it is possible to export the resulting files to PDF, work is ongoing to make this visual work in the PowerBI service so it can be used more widely within organisations !!**
